...
mapeo_archivos_tablas = {
    f'{valor_variable} - Tres-Pedidos.csv': 'cuatrodoctoventascomercial_Pruebas	',
    f'{valor_variable} - Tres-Movto Pedidos comercial.csv': 'cuatromovimientos_Pruebas',
    f'{valor_variable} - Tres-Descuentos.csv': 'cuatrodescuentos_Pruebas',
    f'{valor_variable} - Tres-Descuentos.csv': 'cuatrocuotascxc_Pruebas',
}
...
script_actualizacion = 'update_cuatro.py'
