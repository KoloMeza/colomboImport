...
mapeo_archivos_tablas = {
    f'{valor_variable} - Tres-Pedidos.csv': 'trespedidos_Pruebas',
    f'{valor_variable} - Tres-Movto Pedidos comercial.csv': 'tresmvtopedidos_Pruebas',
    f'{valor_variable} - Tres-Descuentos.csv': 'tresdescuentospedidos_Pruebas',
...
script_actualizacion = 'update_tres.py'
